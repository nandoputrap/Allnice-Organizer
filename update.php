...
//update data
  if(isset($_POST['submit'])){
    ...
    if($kode_pesanan==""||$nama==""||$email==""||$no_telp==""||$jenis_kelamin==""||$jasa==""||$paket==""||$tgl_pemesanan==""||$waktu_pemesanan==""||$tgl_event==""||$tgl_event==""||$daerah==""||$biaya==""||$catatan==""||$catatan_admin==""){
      ...
      <div class="form-pesanan">
        <form class="form-horizontal" action="" method="post">
          ...
          <div class="form-group">
            ...
            <input disabled name="kode_pesanan" placeholder="enter name" <?php echo "value='$old_kode_pesanan'";?> class="form-control"  type="text">
              </div>
            </div>
          </div>
          <!-- end of kode_pesanan -->
